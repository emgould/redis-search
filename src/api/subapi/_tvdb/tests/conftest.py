"""
Shared fixtures and utilities for TVDB service tests.

This conftest uses real API data that has been captured from TVDB API.
...
@pytest.fixture
def mock_tvdb_api_key():
    """Mock TVDB API key."""
    return "test_tvdb_api_key_12345"


@pytest.fixture
def mock_tmdb_api_token():
    """Mock TMDB API token."""
    return "test_tmdb_api_token_12345"


@pytest.fixture
def mock_tvdb_client():
    """Mock TVDB API client."""
